...
/* Блок генерации — гарантированная прокрутка */
.settings-column {
  flex: 0 0 420px;
  background: #fffafc;
  display: flex;
...
/* Мобильные: аккордеон сворачивается */
...
@media (max-width: 860px) {
  ...
  /* Меняем порядок: сначала превью, потом настройки */
  .settings-column {
    order: 2;
    flex: 0 0 auto;
    width: 100%;
