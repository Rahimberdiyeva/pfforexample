...
.pbr-column { flex: 0 0 300px; border-left: 1px solid #f0dfe6; }
...
.center-btn, .file-input-btn, select, button, .integration-btn {
    background: white;
...
.center-btn:hover, .file-input-btn:hover, button:hover, .integration-btn:hover { background: #fff0f5; border-color: #cf8e9e; }
...
.layer-item { display: flex; align-items: center; gap: 8px; padding: 8px 10px; margin-bottom: 6px; background: #fff0f5; border-radius: 30px; cursor: pointer; flex-wrap: wrap; }
...
.footer-item { display: flex; flex-direction: row; align-items: center; gap: 16px; }
...
@media (max-width: 860px) {
    ...
    .logo { font-size: 1.3rem; max-width: 70%; text-align: center; }
    ...
    .category-filters { display: flex; flex-direction: column; gap: 20px; width: 100%; }
    .category-group { display: flex; flex-direction: column; align-items: flex-start; gap: 8px; width: 100%; }
    .category-label { font-size: 0.9rem; font-weight: 600; text-align: left; width: 100%; }
    .category-select { width: 100%; min-width: unset; padding: 8px 12px; font-size: 0.85rem; text-align: left; direction: ltr; }
    .category-select option { text-align: left; }

    .main-layout { flex-direction: column; overflow-y: visible; height: auto; gap: 0; }
    
    .settings-column { flex: 0 0 auto; width: 100%; max-width: 100%; border-bottom: 2px solid #f0dfe6; height: auto; }
    .settings-panel { max-width: 800px; margin: 0 auto; width: 100%; overflow-y: visible; padding-bottom: 20px; }
    .generation-header { position: sticky; top: 0; z-index: 20; background: #d9b7c2cc; backdrop-filter: blur(8px); }

    .preview-wrapper { flex-direction: column; overflow-y: visible; height: auto; border-left: none; }
    ...
    .control-row label { width: 100%; margin-bottom: 4px; }
    .control-row input[type="range"] { width: 100%; }
    .value-display { width: auto; min-width: 45px; text-align: right; }

    .compact-select, .center-btn, .file-input-btn, button, .export-btn { width: 100%; justify-content: center; }
    .model-row, .bg-upload-row { flex-direction: column; align-items: stretch; gap: 10px; }
    .model-row select, .model-row .file-input-btn { width: 100%; margin: 0; }

    .global-footer { display: flex; flex-direction: column; gap: 12px; padding: 12px; background: #fcf0f5; align-items: stretch; }
    .footer-item { display: grid; grid-template-columns: auto 1fr auto; align-items: center; gap: 8px; background: transparent !important; box-shadow: none !important; border: none !important; border-radius: 0 !important; padding: 0 !important; margin: 0 !important; }
    .footer-label { white-space: nowrap; font-size: 0.8rem; font-weight: 700; }
    .footer-controls { display: flex; flex-direction: row; gap: 6px; align-items: center; flex-wrap: wrap; justify-content: flex-start; }
    .footer-item select { padding: 4px 10px; font-size: 0.7rem; min-height: 28px; height: auto; width: auto; min-width: 80px; }
    .footer-item .export-btn { padding: 4px 12px; font-size: 0.7rem; min-height: 28px; width: 85px; text-align: center; white-space: nowrap; }
    .layers-list { max-height: 200px; }
}

@media (max-width: 480px) {
    .logo { font-size: 1.2rem; }
    .color-circle-input { width: 48px; height: 48px; }
    .layer-item { flex-direction: column; align-items: flex-start; }
    .layer-thumb { width: 60px; height: 60px; }
    .footer-item { grid-template-columns: auto 1fr auto; gap: 6px; }
    .footer-item select, .footer-item .export-btn { padding: 3px 8px; font-size: 0.65rem; }
    .footer-item .export-btn { width: 75px; }
}
