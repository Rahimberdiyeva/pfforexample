...
// --- Освещение (без HDRI для простоты) ---
...
// Убираем HDRI контролы (не используются)
// Оставляем только заглушки, чтобы не было ошибок
document.getElementById('hdriIntensity')?.addEventListener('input', () => {});
document.getElementById('hdriRotation')?.addEventListener('input', () => {});
